...
master = Tk()
master.title("muskan 211P067 Segmentation using Machine Learning")
Label(master, text=" muskan 211P067 Customer Segmentation using Machine Learning", bg="Yellow", fg="black").grid(row=0, columnspan=2)
