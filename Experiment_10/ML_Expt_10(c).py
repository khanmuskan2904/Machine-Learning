...
print("\nClassification Report By muskan 211P067:")
print(classification_report(y_test, y_pred, target_names=data.target_names))

# Optional: Feature Importance Plot
lgb.plot_importance(lgb_model, max_num_features=10, importance_type='split', title='Feature Importance By muskan 211P067')
plt.show()